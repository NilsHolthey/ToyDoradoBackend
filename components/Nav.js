...
export default function Nav({ show, setShow }) {
  ...
  const activeLink = inactiveLink + ' bg-highlight text-gray-900 rounded-sm';
  ...
  return (
    <aside
      className={
        ...
        ' top-0 text-gray-500 p-4 fixed w-full bg-bgGray h-full md:static md:w-auto transition-all duration-300'
      }
    >
      ...
      <nav className="flex flex-col gap-2">
        ...
        <button className={inactiveLink + ' mt-3'} onClick={logout}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
